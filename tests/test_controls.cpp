...
TUINATOR_TEST(progress_bar_plain_renders_arrow) {
    ...
    tuinator::ProgressBar bar(0.5, tuinator::progress_bar_preset(
        tuinator::ProgressBarLayout::Plain,
        tuinator::Theme{}.accent,
...
TUINATOR_TEST(progress_bar_filled_label_centers_text) {
    ...
    auto options = tuinator::progress_bar_preset(
        tuinator::ProgressBarLayout::FilledLabel,
        tuinator::Theme{}.accent,
        tuinator::Theme{}.muted);
...
TUINATOR_TEST(progress_bar_pulse_renders_placeholders) {
    ...
    auto options = tuinator::progress_bar_preset(
        tuinator::ProgressBarLayout::Pulse,
        tuinator::Theme{}.accent,
        tuinator::Theme{}.muted);
...
TUINATOR_TEST(progress_bar_shimmer_renders_label) {
    ...
    tuinator::ProgressBar bar(0.0, tuinator::progress_bar_preset(
        tuinator::ProgressBarLayout::Shimmer,
        tuinator::Theme{}.accent,
        tuinator::Theme{}.muted));
    bar.layout({0, 0, 36, 1});
...
TUINATOR_TEST(progress_bar_bounce_renders_brackets) {
    ...
    tuinator::ProgressBar bar(0.0, tuinator::progress_bar_preset(
        tuinator::ProgressBarLayout::Bounce,
        tuinator::Theme{}.accent,
        tuinator::Theme{}.muted));
    bar.layout({0, 0, 16, 1});
...
TUINATOR_TEST(progress_bar_filled_label_indeterminate_animates) {
    ...
    auto options = tuinator::progress_bar_filled_label(
        tuinator::Theme{}.accent,
        tuinator::Theme{}.muted,
        "Loading...",
...
TUINATOR_TEST(progress_bar_bracketed_renders_caps) {
    ...
    tuinator::ProgressBar bar(0.5, tuinator::progress_bar_preset(
        tuinator::ProgressBarLayout::Bracketed,
        tuinator::Theme{}.accent,
        tuinator::Theme{}.muted));
    bar.layout({0, 0, 24, 1});
