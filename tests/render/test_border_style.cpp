...
void check_corners_distinct(const tuinator::BorderGlyphs& a, const tuinator::BorderGlyphs& b) {
...
void check_edges_distinct(const tuinator::BorderGlyphs& a, const tuinator::BorderGlyphs& b) {
...
TUINATOR_TEST(border_style_from_glyph_set_mapping) {
    TUINATOR_CHECK_EQ(tuinator::border_style_from_glyph_set(tuinator::GlyphSet::Ascii), tuinator::BorderStyle::Ascii);
    TUINATOR_CHECK_EQ(tuinator::border_style_from_glyph_set(tuinator::GlyphSet::Unicode), tuinator::BorderStyle::Light);
    TUINATOR_CHECK_EQ(tuinator::border_style_from_glyph_set(tuinator::GlyphSet::UnicodeRounded),
                      tuinator::BorderStyle::Rounded);
}

TUINATOR_TEST(glyph_set_backward_compat_maps_to_border_style) {
    TUINATOR_CHECK_EQ(tuinator::border_glyphs_for(tuinator::GlyphSet::Unicode).top_left,
                      tuinator::border_glyphs_for(tuinator::BorderStyle::Light).top_left);
    TUINATOR_CHECK_EQ(tuinator::border_glyphs_for(tuinator::GlyphSet::UnicodeRounded).top_left,
