...
int main() {
    ...
    auto username = std::make_unique<tuinator::TextInput>(
        tuinator::TextInputOptions{.min_width = 24, .placeholder = "guest"},
        theme.text_input,
    ...
    auto password = std::make_unique<tuinator::TextInput>(
        tuinator::TextInputOptions{.min_width = 24, .placeholder = "secret"},
        theme.text_input,
        theme.text_input_focused);
    ...
    auto preview = std::make_unique<tuinator::Label>(
        "Signed in as: guest",
        theme.muted);
    ...
    form->add_child(std::make_unique<tuinator::Label>(
        "Tab between fields | type to edit | q to quit",
        theme.muted));
