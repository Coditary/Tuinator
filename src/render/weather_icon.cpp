...
constexpr WeatherIconDescriptor make(
    WeatherIcon kind,
    WeatherIconCategory category,
    const char* path,
...
constexpr std::array<WeatherIconDescriptor, 119> kDescriptors{{
    ...
    make(WeatherIcon::DayCloudyGusts, WeatherIconCategory::Day, "weather-day-cloudy-gusts", "day_cloudy_gusts", 0xE300, 'o'),
    make(WeatherIcon::DayCloudyHigh, WeatherIconCategory::Day, "weather-day-cloudy-high", "day_cloudy_high", 0xE376, 'o'),
    make(WeatherIcon::DayCloudyWindy, WeatherIconCategory::Day, "weather-day-cloudy-windy", "day_cloudy_windy", 0xE301, 'o'),
    ...
    make(WeatherIcon::DaySnowThunderstorm, WeatherIconCategory::Day, "weather-day-snow-thunderstorm", "day_snow_thunderstorm", 0xE365, '*'),
    ...
    make(WeatherIcon::DayStormShowers, WeatherIconCategory::Day, "weather-day-storm-showers", "day_storm_showers", 0xE30E, 'r'),
    make(WeatherIcon::DaySunny, WeatherIconCategory::Day, "weather-day-sunny", "day_sunny", 0xE30D, 'o'),
    make(WeatherIcon::DaySunnyOvercast, WeatherIconCategory::Day, "weather-day-sunny-overcast", "day_sunny_overcast", 0xE30C, 'o'),
    make(WeatherIcon::DayThunderstorm, WeatherIconCategory::Day, "weather-day-thunderstorm", "day_thunderstorm", 0xE30F, 'o'),
    make(WeatherIcon::DayWindy, WeatherIconCategory::Day, "weather-day-windy", "day_windy", 0xE37D, 'o'),
    make(WeatherIcon::NightAltCloudy, WeatherIconCategory::NightAlt, "weather-night-alt-cloudy", "night_alt_cloudy", 0xE37E, 'n'),
    make(WeatherIcon::NightAltCloudyGusts, WeatherIconCategory::NightAlt, "weather-night-alt-cloudy-gusts", "night_alt_cloudy_gusts", 0xE31F, 'n'),
    make(WeatherIcon::NightAltCloudyHigh, WeatherIconCategory::NightAlt, "weather-night-alt-cloudy-high", "night_alt_cloudy_high", 0xE377, 'n'),
    make(WeatherIcon::NightAltCloudyWindy, WeatherIconCategory::NightAlt, "weather-night-alt-cloudy-windy", "night_alt_cloudy_windy", 0xE320, 'n'),
    make(WeatherIcon::NightAltHail, WeatherIconCategory::NightAlt, "weather-night-alt-hail", "night_alt_hail", 0xE321, 'n'),
    make(WeatherIcon::NightAltLightning, WeatherIconCategory::NightAlt, "weather-night-alt-lightning", "night_alt_lightning", 0xE322, 'n'),
    make(WeatherIcon::NightAltPartlyCloudy, WeatherIconCategory::NightAlt, "weather-night-alt-partly-cloudy", "night_alt_partly_cloudy", 0xE379, 'n'),
    make(WeatherIcon::NightAltRain, WeatherIconCategory::NightAlt, "weather-night-alt-rain", "night_alt_rain", 0xE325, 'r'),
    make(WeatherIcon::NightAltRainMix, WeatherIconCategory::NightAlt, "weather-night-alt-rain-mix", "night_alt_rain_mix", 0xE323, 'r'),
    make(WeatherIcon::NightAltRainWind, WeatherIconCategory::NightAlt, "weather-night-alt-rain-wind", "night_alt_rain_wind", 0xE324, 'r'),
    make(WeatherIcon::NightAltShowers, WeatherIconCategory::NightAlt, "weather-night-alt-showers", "night_alt_showers", 0xE326, 'r'),
    make(WeatherIcon::NightAltSleet, WeatherIconCategory::NightAlt, "weather-night-alt-sleet", "night_alt_sleet", 0xE3AC, '*'),
    make(WeatherIcon::NightAltSleetStorm, WeatherIconCategory::NightAlt, "weather-night-alt-sleet-storm", "night_alt_sleet_storm", 0xE364, '*'),
    make(WeatherIcon::NightAltSnow, WeatherIconCategory::NightAlt, "weather-night-alt-snow", "night_alt_snow", 0xE327, '*'),
    make(WeatherIcon::NightAltSnowThunderstorm, WeatherIconCategory::NightAlt, "weather-night-alt-snow-thunderstorm", "night_alt_snow_thunderstorm", 0xE367, '*'),
    make(WeatherIcon::NightAltSnowWind, WeatherIconCategory::NightAlt, "weather-night-alt-snow-wind", "night_alt_snow_wind", 0xE361, '*'),
    make(WeatherIcon::NightAltSprinkle, WeatherIconCategory::NightAlt, "weather-night-alt-sprinkle", "night_alt_sprinkle", 0xE328, 'n'),
    make(WeatherIcon::NightAltStormShowers, WeatherIconCategory::NightAlt, "weather-night-alt-storm-showers", "night_alt_storm_showers", 0xE329, 'r'),
    make(WeatherIcon::NightAltThunderstorm, WeatherIconCategory::NightAlt, "weather-night-alt-thunderstorm", "night_alt_thunderstorm", 0xE32A, 'n'),
    ...
    make(WeatherIcon::NightCloudyGusts, WeatherIconCategory::Night, "weather-night-cloudy-gusts", "night_cloudy_gusts", 0xE32C, 'n'),
    make(WeatherIcon::NightCloudyHigh, WeatherIconCategory::Night, "weather-night-cloudy-high", "night_cloudy_high", 0xE378, 'n'),
    make(WeatherIcon::NightCloudyWindy, WeatherIconCategory::Night, "weather-night-cloudy-windy", "night_cloudy_windy", 0xE32D, 'n'),
    ...
    make(WeatherIcon::NightLightning, WeatherIconCategory::Night, "weather-night-lightning", "night_lightning", 0xE330, 'n'),
    make(WeatherIcon::NightPartlyCloudy, WeatherIconCategory::Night, "weather-night-partly-cloudy", "night_partly_cloudy", 0xE37B, 'n'),
    make(WeatherIcon::NightRain, WeatherIconCategory::Night, "weather-night-rain", "night_rain", 0xE333, 'r'),
    make(WeatherIcon::NightRainMix, WeatherIconCategory::Night, "weather-night-rain-mix", "night_rain_mix", 0xE331, 'r'),
    make(WeatherIcon::NightRainWind, WeatherIconCategory::Night, "weather-night-rain-wind", "night_rain_wind", 0xE332, 'r'),
    ...
    make(WeatherIcon::NightSleetStorm, WeatherIconCategory::Night, "weather-night-sleet-storm", "night_sleet_storm", 0xE363, '*'),
    make(WeatherIcon::NightSnow, WeatherIconCategory::Night, "weather-night-snow", "night_snow", 0xE335, '*'),
    make(WeatherIcon::NightSnowThunderstorm, WeatherIconCategory::Night, "weather-night-snow-thunderstorm", "night_snow_thunderstorm", 0xE366, '*'),
    make(WeatherIcon::NightSnowWind, WeatherIconCategory::Night, "weather-night-snow-wind", "night_snow_wind", 0xE360, '*'),
    make(WeatherIcon::NightSprinkle, WeatherIconCategory::Night, "weather-night-sprinkle", "night_sprinkle", 0xE336, 'n'),
    make(WeatherIcon::NightStormShowers, WeatherIconCategory::Night, "weather-night-storm-showers", "night_storm_showers", 0xE337, 'r'),
    make(WeatherIcon::NightThunderstorm, WeatherIconCategory::Night, "weather-night-thunderstorm", "night_thunderstorm", 0xE338, 'n'),
    ...
    make(WeatherIcon::SnowflakeCold, WeatherIconCategory::Precipitation, "weather-snowflake-cold", "snowflake_cold", 0xE36F, '*'),
    ...
    make(WeatherIcon::HurricaneWarning, WeatherIconCategory::Storm, "weather-hurricane-warning", "hurricane_warning", 0xE3C7, '*'),
...
WeatherIconCategory weather_icon_category(WeatherIcon icon) {
    return weather_icon_descriptor(icon).category;
}

const char* weather_icon_path(WeatherIcon icon) {
    return weather_icon_descriptor(icon).path;
}

const char* weather_icon_nerd_suffix(WeatherIcon icon) {
    return weather_icon_descriptor(icon).nerd_suffix;
}

const char* weather_icon_category_path(WeatherIconCategory category) {
    switch (category) {
    case WeatherIconCategory::Day:
        return "weather-day";
    case WeatherIconCategory::NightAlt:
        return "weather-night-alt";
    case WeatherIconCategory::Night:
        return "weather-night";
    case WeatherIconCategory::Cloud:
        return "weather-cloud";
    case WeatherIconCategory::Precipitation:
        return "weather-precipitation";
    case WeatherIconCategory::Storm:
        return "weather-storm";
    case WeatherIconCategory::Wind:
        return "weather-wind";
    case WeatherIconCategory::Unavailable:
        return "weather-unavailable";
    case WeatherIconCategory::Equipment:
        return "weather-equipment";
    case WeatherIconCategory::Misc:
        return "weather-misc";
    }
    return "weather";
}
